...
cart.forEach((product, i) => {
    ...
    cartItemImage.setAttribute('src', 'something.imageUrl') //placeholder
    cartItemImage.setAttribute('alt', 'something.altTxt')//placeholder
    ...
    productName.textContent = 'SOMETHING.VALUE'; //placeholder
    let productColor = document.createElement('p');
    productColor.textContent = cart[i].color; //placeholder cart[i].color(.value?)
    let productPrice = document.createElement('p');
    productPrice.textContent = 'SOMETHING.VALUE' //placeholder;
    ...
    cartItemSettingsQuantityText.textContent = 'Quantity :' // placeholder
    ...
    cartItemSettingsInput.setAttribute('value', cart[i].quantity) //placeholder
...
const allData = Promise.all(fetchArray);//updated products info
*/